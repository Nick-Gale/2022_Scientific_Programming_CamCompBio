...
* About 9,000 packages registered (October 2023).
...
* Package management in Julia is easiest using the Pkg package, or the package environment.

* To access package press `]` in the REPL. To exit press backspace in the enviroment.
