...
---
## Types and Hierarchy {.slide-number=true}

* Julia has a hierarchy of types e.g. Int <: Real <: Number <: Any.
...
struct Stats
## a statistics container of the mean, variance, and kurtosis entered by user
	xbar::Real
	xsig::Real
	xkur::Real
end
